...
import { FaArrowRight, FaBolt, FaLock } from "react-icons/fa";
...
export default function HomePage() {
  const features = [
    {
      icon: (
        <HiSparkles className="h-5 w-5 text-yellow-600 lg:h-6 lg:w-6 dark:text-yellow-400" />
      ),
      title: "IA Integrada",
    ...
    {
      icon: (
        <HiRectangleGroup className="h-5 w-5 text-blue-600 lg:h-6 lg:w-6 dark:text-blue-400" />
      ),
      title: "Workspaces",
    ...
    {
      icon: (
        <FaBolt className="h-5 w-5 text-green-600 lg:h-6 lg:w-6 dark:text-green-400" />
      ),
      title: "Real-time",
    ...
    {
      icon: (
        <FaLock className="h-5 w-5 text-red-600 lg:h-6 lg:w-6 dark:text-red-400" />
      ),
      title: "Segurança",
      ...
      <div className="z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center gap-8 px-4 py-8 text-center sm:px-6 md:flex-row md:gap-12 md:py-12 md:text-left lg:gap-20 lg:px-8 lg:py-16 xl:gap-28">
        ...
        <div className="flex w-full flex-col items-center md:max-w-xl md:items-start lg:max-w-2xl">
          ...
          <p className="mb-5 max-w-xl text-sm leading-relaxed text-neutral-600 sm:text-base lg:mb-7 lg:text-lg dark:text-neutral-400">
            Tudo que você precisa para capturar, organizar e compartilhar — com
            inteligência artificial integrada ao seu fluxo.
          </p>
          ...
          <div className="flex w-full flex-col items-center justify-center gap-3 sm:flex-row md:justify-start">
            ...
            <Link
              href="/about"
              className="text-sm font-medium text-neutral-600 transition-colors hover:text-neutral-900 lg:text-base dark:text-neutral-400 dark:hover:text-white"
            >
              Saiba mais →
            </Link>
          </div>
