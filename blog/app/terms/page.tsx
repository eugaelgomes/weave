...
const sections = [
  { title: "1. Aceitação dos Termos", id: "aceitacao" },
  { title: "2. Descrição do Serviço", id: "descricao" },
  { title: "3. Cadastro e Conta", id: "cadastro" },
  { title: "4. Uso Aceitável", id: "uso-aceitavel" },
  { title: "5. Propriedade Intelectual", id: "propriedade-intelectual" },
  { title: "6. Integrações com Terceiros", id: "integracoes" },
  { title: "7. Disponibilidade e Modificações", id: "disponibilidade" },
  { title: "8. Limitação de Responsabilidade", id: "responsabilidade" },
  { title: "9. Encerramento de Conta", id: "encerramento" },
  { title: "10. Legislação Aplicável", id: "legislacao" },
  { title: "11. Contato", id: "contato" },
];
          ...
          <div className="space-y-8 text-sm leading-relaxed text-neutral-600 sm:text-base dark:text-neutral-400">
            ...
            <section id="descricao">
              ...
              <p>
                ...
                Plataforma pode incluir integrações with serviços de terceiros,
