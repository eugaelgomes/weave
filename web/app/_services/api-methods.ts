...
export const API_ENDPOINTS = {
  ...
  SAML_SSO_LOGIN: (workspaceId: string) => `/auth/sso/saml/${workspaceId}/login`,
  SIGNUP: "/users/signup",
  LOGOUT: "/auth/logout",
  ME: "/users/me",
  AUTH_SESSIONS: "/auth/sessions",
  AUTH_SESSION_BY_ID: (sessionId: string) => `/auth/sessions/${sessionId}`,
  AUTH_SESSIONS_OTHERS: "/auth/sessions/others",
  ...
  ORGANIZATIONS_CREATION_STEP_ONE_COMPLETE: "/workspaces/creation-steps/step-1/complete",
  ORGANIZATIONS_PROPERTIES: "/workspaces/properties",
  ORGANIZATIONS_RESTORE: "/workspaces/restore",
  ORGANIZATIONS_MEMBERS: "/workspaces/members",
  ORGANIZATIONS_MEMBER: (memberId: string) => `/workspaces/members/${memberId}`,
  ORGANIZATIONS_INVITES: "/workspaces/invites",
  ORGANIZATIONS_DOMAINS: "/workspaces/domains",
  ORGANIZATIONS_DOMAIN_VERIFY: (id: string) => `/workspaces/domains/${id}/verify`,
  ORGANIZATIONS_DOMAIN_DELETE: (id: string) => `/workspaces/domains/${id}`,
  ORGANIZATIONS_LOGO: "/workspaces/logo",
  ORGANIZATIONS_BANNER: "/workspaces/banner",
  ORGANIZATIONS_AREAS: "/workspaces/areas",
  ORGANIZATIONS_AREA_BY_ID: (id: string) => `/workspaces/areas/${id}`,
  ORGANIZATIONS_AREA_MEMBERS: (id: string) => `/workspaces/areas/${id}/members`,
  ORGANIZATIONS_AREA_MEMBER: (areaId: string, memberId: string) =>
    `/workspaces/areas/${areaId}/members/${memberId}`,
