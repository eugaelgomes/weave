...
export function Stats({ stats, projectsStats, tagCloudData }: StatsProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-2 lg:grid-cols-[260px_1fr]">
      {/* === CARD 1 — MÉTRICAS === */}
      <div className="dark:border-surface-dark-border flex flex-col rounded-md border border-neutral-200 bg-neutral-50 shadow-md backdrop-blur-sm dark:bg-[#1d1d1b]">
        <button
          onClick={() => setShowMetrics(!showMetrics)}
          className="dark:border-surface-dark-border flex w-full items-center justify-between border-b border-neutral-200 bg-neutral-50 px-3 py-2 sm:px-4 dark:bg-[#1d1d1b]/50"
        >
      ...
      <div className="dark:border-surface-dark-border flex flex-col rounded-md border border-neutral-200 bg-neutral-50 shadow-md backdrop-blur-sm dark:bg-[#1d1d1b]">
        <button
          ...
          className="dark:border-surface-dark-border flex w-full items-center justify-between border-b border-neutral-200 bg-neutral-50 px-3 py-2 sm:px-4 dark:bg-[#1d1d1b]/30"
        >
          <h3 className="font-mono text-[9px] font-bold tracking-widest text-neutral-600 uppercase sm:text-[10px] dark:text-neutral-500">
            {t.home.tagCloud}
          </h3>
