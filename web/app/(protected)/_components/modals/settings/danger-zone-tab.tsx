...
export const SettingsDangerZone: React.FC<any> = ({
  ...
  React.useEffect(() => {
    const handleHashChange = () => {
      ...
      setModalBackup(hash === settingsHash("security/backup"));
      setModalDelete(hash === settingsHash("security/delete"));
    };
    handleHashChange();
    ...
    <div className="overflow-hidden rounded-md border border-red-200/50 bg-white shadow-sm dark:border-red-900/20 dark:bg-[#1d1d1b]">
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <button
            onClick={() => {
              window.location.hash = settingsHash("security/backup");
            }}
        ...
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <button
            onClick={() => {
              window.location.hash = settingsHash("security/delete");
            }}
      ...
      <ConfirmationModal
        isOpen={modalBackup}
        onClose={() => {
          window.location.hash = settingsHash("security");
        }}
        onConfirm={() => {
          handleCreateBackup();
          window.location.hash = settingsHash("security");
