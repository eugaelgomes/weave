  ...
  const WORKSPACE_NAV: WorkspaceNavItem[] = useMemo(
    () => [
      ...
      },
      {
        icon: Users,
        label: t.nav.members,
        href: routes.workspace.membersList(publicId),
        ...
        subItems: [
          ...
          },
          {
            icon: MessageSquare,
            label: t.nav.invites,
            href: routes.workspace.membersInvites(publicId),
      ...
      },
      {
        icon: Workflow,
        label: t.nav.areas,
        href: routes.workspace.areas(publicId),
        type: "workspaceAreas",
      },
      {
        icon: Network,
        label: t.nav.projects,
        href: routes.workspace.projects(publicId),
        type: "workspaceProjects",
      },
      {
        icon: PenLine,
        label: t.nav.editor,
        href: routes.workspace.editor(publicId),
        matchPaths: [routes.workspace.about(publicId)],
