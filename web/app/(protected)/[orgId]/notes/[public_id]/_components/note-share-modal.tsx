          ...
          {searchResults.length > 0 ? (
            <div className="max-h-48 space-y-1.5 overflow-y-auto sm:max-h-36">
              {searchResults.map((user) => (
                <div
                  key={user.id}
                  className="dark:border-surface-dark-border flex items-center justify-between rounded-md border border-neutral-100 bg-neutral-50 p-2.5 transition-colors hover:bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-neutral-700"
                >
