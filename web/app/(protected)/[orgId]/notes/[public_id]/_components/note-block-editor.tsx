...
import {
  NoteRichContent,
  type ContentMark,
} from "@/app/(protected)/notes/[public_id]/_components/note-rich-content";
import {
  NoteFormatToolbar,
  type MarkdownToolbarActions,
} from "@/app/(protected)/notes/[public_id]/_components/note-format-toolbar";
import { useAutoResizeTextarea } from "@/app/(protected)/notes/[public_id]/_hooks/use-auto-resize-textarea";
