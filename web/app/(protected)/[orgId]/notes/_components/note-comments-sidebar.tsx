...
export function NoteCommentsSidebar({
  ...
  const renderComment = (c: CommentNode, depth: number) => {
    ...
    return (
      ...
      >
        <div className="dark:border-surface-dark-border rounded-lg border border-neutral-200 bg-neutral-50/90 px-3 py-3 dark:bg-[#1d1d1b]/50">
              ...
              {isEditing ? (
                <div className="space-y-2">
                  <CommentComposerTextarea
                    ...
                    className="dark:border-surface-dark-border-strong w-full resize-y rounded-md border border-neutral-200 bg-white px-2 py-1.5 text-sm dark:bg-[#1d1d1b]"
                  />
                  <input
                  ...
                  {editFiles.length > 0 && (
                    <ul className="flex flex-wrap gap-1 text-[11px]">
                      {editFiles.map((f) => (
                        <li
                          key={f.id}
                          className="dark:border-surface-dark-border-strong flex items-center gap-1 rounded border border-neutral-200 px-1.5 py-0.5"
                        >
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="dark:border-surface-dark-border-strong inline-flex items-center gap-1 rounded border border-neutral-200 px-2 py-1 text-[11px]"
                    >
                      ...
                      {files.map((f) => (
                        <li key={f.id}>
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="dark:hover:text-brand-primary-500 dark:border-surface-dark-border-strong inline-flex items-center gap-1 rounded-md border border-neutral-200 bg-white px-2 py-1 text-[11px] text-neutral-600 dark:bg-[#1d1d1b] dark:text-neutral-300"
                          >
                            <span className="max-w-[120px] truncate">{f.name}</span>
                            <Download size={10} />
                          </a>
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-white dark:bg-[#1d1d1b]">
      <div className="dark:border-surface-dark-border flex flex-shrink-0 items-center justify-between gap-2 rounded-md border border-neutral-200 px-3 py-1">
      ...
      {canComment && (
        <div className="dark:border-surface-dark-border flex-shrink-0 border-t border-neutral-200 bg-neutral-50/80 px-3 py-3 dark:bg-[#1d1d1b]/30">
          {replyingTo && (
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-2">
            <CommentComposerTextarea
              ...
              rows={3}
              className="dark:border-surface-dark-border-strong w-full resize-y rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-800 placeholder-neutral-400 outline-none focus:border-yellow-500 dark:bg-[#1d1d1b] dark:text-neutral-100"
            />
            <input
              ref={fileInputRef}
              type="file"
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="dark:border-surface-dark-border-strong inline-flex items-center gap-1 rounded-md border border-neutral-200 px-2.5 py-1.5 text-xs"
              >
