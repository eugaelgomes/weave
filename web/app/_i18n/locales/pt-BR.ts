const ptBR = {
  ...
  organizationGeneral: {
    ...
    allowPublicNotes: "Permitir Tarefas Públicas",
    allowPublicNotesHint: "Habilitar compartilhamento público",
    locationSectionTitle: "Localização",
    ...
    featureAiAgent: "Assistente de IA",
    featureAiAgentHint: "Recursos de inteligência artificial",
    featureBackup: "Backup Automático",
    featureBackupHint: "Backup diário de tarefas",
    featureCollaboration: "Colaboração em tempo real",
    featureCollaborationHint: "Edição simultânea",
    notificationsSectionTitle: "Notificações",
    notificationEmail: "Emails",
    notificationPush: "Notificações Push",
  ...
  organizationIntegrations: {
    ...
    emptyBody: "Conecte ferramentas externas para expandir o potencial.",
    domainsTitle: "Domínios Customizados",
    reloadDomains: "Recarregar",
    domainPlaceholder: "exemplo.com",
    addDomain: "Adicionar",
    domainsEmpty: "Nenhum domínio configurado.",
    domainsLoadError: "Erro ao carregar domínios",
    domainAdded: "Domínio adicionado! Configure o DNS para verificar.",
    domainAddError: "Erro ao adicionar domínio",
    domainVerified: "Domínio verificado com sucesso!",
    domainVerifyFailed: "Verificação falhou. Verifique os registros DNS.",
    domainVerifyError: "Erro na verificação",
    domainDeleteConfirm: "Tem certeza que deseja remover este domínio?",
    domainRemoved: "Domínio removido",
    domainRemoveError: "Erro ao remover domínio",
    ...
    dnsHint: "Adicione um registro TXT ao seu DNS para verificar a propriedade.",
  ...
  organizationMembers: {
    ...
    areaRequired: "Área",
    areaInviteNoAreas: "Crie pelo menos uma área antes de convidar membros.",
  ...
  headers: {
    ...
    workspace: "— gerencie as configurações da organização.",
    workspaceMembers: "— gerencie membros e papéis da equipe.",
    workspaceInvites: "— revise e gerencie convites pendentes.",
    workspaceAreas: "— organize equipes e áreas.",
    workspaceProjects: "— visualize os projetos da organização.",
    workspacePlans: "— acompanhe plano e limites de uso.",
    workspaceIntegrations: "— conecte ferramentas e domínios.",
    workspaceEditor: "— edite a página pública do workspace.",
  ...
  weaveAi: {
    ...
    welcomeGreetingPrefix: "Olá",
    welcomeGreetingSuffix: "com o",
    welcomeGreetingAction: "você pode",
  ...
  clientTokens: {
    pageDescription: "Gerencie seus tokens de cliente e permissões de acesso.",
    ...
    managementDesc: "Chaves de acesso para scripts e integrações Weave.",
    activeToken: "Ativo",
    activeTokens: "Ativos",
    revokedToken: "Revogado",
    revokedTokens: "Revogados",
    readDocs: "Ler documentação oficial",
    tokenGeneratedTitle: "Token Gerado com Sucesso!",
    tokenGeneratedDesc: "Copie-o agora. Por segurança, não poderemos exibi-lo novamente.",
    copied: "Copiado",
    copy: "Copiar",
    closeWarning: "Fechar aviso",
    newTokenTitle: "Novo Token de Acesso",
    identifierLabel: "Identificação",
    identifierPlaceholder: "Ex: Integração CI/CD",
    ...
    days30: "30 dias",
    days90: "90 dias",
    scopesLabel: "Permissões de Escopo",
    continue: "Continuar",
    listTitle: "Lista de Tokens Ativos e Revogados",
    newTokenBtn: "Novo Token",
    tableColName: "Nome",
    tableColPrefix: "Prefixo",
    tableColScopes: "Escopos",
    tableColCreated: "Criação",
    tableColExpires: "Expiração",
    tableColRevoked: "Revogação",
