...
const esES: TranslationKeys = {
  ...
  home: {
    ...
    engine: {
      title: "Weave Engine",
      titleVariations: [
        "Analizando la actividad reciente, tu agente identificó:",
        "Según tus proyectos activos, el diagnóstico de hoy es:",
        "Siguiendo la línea de razonamiento del agente, tenemos este escenario:",
        "Tu agente procesó las actualizaciones y sugiere enfocarse en:",
        "Cruzando los datos de tu espacio de trabajo, el análisis indica:",
      ],
  ...
  organizationMembers: {
    ...
    removeAccessQuestion:
      "¿Seguro que deseas eliminar a {name} de la organización? Perderá el acceso a todos los proyectos y datos.",
  ...
  weaveAi: {
    ...
    welcomeGreetingPrefix: "Hola",
    welcomeGreetingSuffix: "con",
    welcomeGreetingAction: "puedes",
  ...
  clientTokens: {
    pageDescription: "Administre sus tokens de cliente y permisos de acceso.",
    ...
    managementDesc: "Claves de acceso para scripts e integraciones de Weave.",
    activeToken: "Activo",
    activeTokens: "Activos",
    revokedToken: "Revocado",
    revokedTokens: "Revocados",
    readDocs: "Leer documentación oficial",
    tokenGeneratedTitle: "¡Token Generado con Éxito!",
    tokenGeneratedDesc: "Cópialo ahora. Por seguridad, no podremos mostrarlo de nuevo.",
    copied: "Copiado",
    copy: "Copiar",
    closeWarning: "Cerrar aviso",
    newTokenTitle: "Nuevo Token de Acceso",
    identifierLabel: "Identificación",
    identifierPlaceholder: "Ej: Integración CI/CD",
    ...
    days30: "30 días",
    days90: "90 días",
    scopesLabel: "Permisos de Ámbito",
    continue: "Continuar",
    listTitle: "Lista de Tokens Activos y Revocados",
    newTokenBtn: "Nuevo Token",
    tableColName: "Nombre",
    tableColPrefix: "Prefijo",
    tableColScopes: "Ámbitos",
    tableColCreated: "Creación",
    tableColExpires: "Expiración",
    tableColRevoked: "Revocación",
