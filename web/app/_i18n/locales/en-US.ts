...
const enUS: TranslationKeys = {
  ...
  weaveAi: {
    ...
    welcomeGreetingSuffix: "with",
    welcomeGreetingAction: "you can",
  ...
  clientTokens: {
    pageDescription: "Manage your client tokens and access permissions.",
    ...
    managementDesc: "Access keys for scripts and Weave integrations.",
    activeToken: "Active",
    activeTokens: "Active",
    revokedToken: "Revoked",
    revokedTokens: "Revoked",
    readDocs: "Read official documentation",
    tokenGeneratedTitle: "Token Generated Successfully!",
    tokenGeneratedDesc: "Copy it now. For security, we won't be able to display it again.",
    copied: "Copied",
    copy: "Copy",
    closeWarning: "Close warning",
    newTokenTitle: "New Access Token",
    identifierLabel: "Identifier",
    identifierPlaceholder: "Ex: CI/CD Integration",
    ...
    days30: "30 days",
    days90: "90 days",
    scopesLabel: "Scope Permissions",
    continue: "Continue",
    listTitle: "Active and Revoked Tokens List",
    newTokenBtn: "New Token",
    tableColName: "Name",
    tableColPrefix: "Prefix",
    tableColScopes: "Scopes",
    tableColCreated: "Created",
    tableColExpires: "Expires",
    tableColRevoked: "Revoked",
