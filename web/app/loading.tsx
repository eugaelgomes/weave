...
export default function Loading() {
  return (
    <div className="flex h-full min-h-screen w-full flex-col items-center justify-center bg-neutral-50 text-neutral-800 dark:bg-neutral-950 dark:text-neutral-200">
      <div className="relative mb-8 flex items-center justify-center">
        ...
        <div className="relative z-10 flex h-16 w-16 animate-pulse items-center justify-center rounded-full bg-neutral-200 shadow-xl shadow-yellow-900/10 dark:bg-neutral-900">
