  ...
  if (showProfileSetup) {
    return (
      <SetProfileSettings
        locale={locale}
        onSkip={() =>
          router.push(user?.workspace_public_id ? `/${user.workspace_public_id}/home` : "/account/onboarding")
        }
        onComplete={() =>
          router.push(user?.workspace_public_id ? `/${user.workspace_public_id}/home` : "/account/onboarding")
        }
              ...
              {canSetupProfile ? (
                <>
                  ...
                  <button
                    ...
                    onClick={() =>
                      router.push(
                        user?.workspace_public_id ? `/${user.workspace_public_id}/home` : "/account/onboarding"
                      )
                    }
