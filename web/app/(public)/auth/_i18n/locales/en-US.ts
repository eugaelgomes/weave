export const enUS = {
  signIn: {
    ...
    buildAgents: "Build your agents",
    buildAgentsTagline: "Build your autonomous agents with",
    subtitle: "Proactive Projects Platform",
    usernameLabel: "Username or Email",
    usernamePlaceholder: "Username or Email",
    passwordLabel: "Password",
    passwordPlaceholder: "Password",
    codeModeDescription: "We will send a 6-digit code to your email.",
    ...
    samlSsoEmailRequired: "Enter a valid email to continue with SAML SSO.",
    samlSsoNotAvailable: "This domain is not configured for SAML SSO. Use email signup instead.",
  },
  signUp: {
    title: "Create Account",
    subtitle: "Create your account with email and password, then start using Weave.",
    emailLabel: "Email",
  ...
  confirmAccount: {
    ...
    resendError: "We could not resend the code.",
    missingEmailError: "Enter your email to resend the code.",
