...
// Importação dos nossos novos módulos (Dumb Components)
import { SettingsProfileData } from "../_components/ui/settings/profile-data";
import { SettingsOrgAndPlan } from "../_components/ui/settings/org-and-plans";
import { SettingsProfilePreferences } from "../_components/ui/settings/profile-preferences";
import { SettingsDangerZone } from "../_components/ui/settings/danger-zone";
...
const SettingsPage = () => {
  ...
  const handleCreateBackup = async () => {
    try {
      ...
      const estimatedTime = response.estimated_time
        ...
        : "";
      setBackupMessage(`${response.message || "Cópia de segurança em processamento..."}${estimatedTime}`);
  ...
  const handleDeleteAccount = async () => {
    if (!window.confirm("ATENÇÃO: Esta ação é irreversível. Deseja realmente eliminar a sua conta?"))
      return;
