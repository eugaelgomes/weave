      ...
      <div className="border-b border-neutral-200 bg-white px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2">
            <div className="rounded bg-brand-primary-700/10 p-1.5">
              <BarChart3 className="h-4 w-4 text-brand-primary-700" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button className="flex h-7 items-center justify-center gap-1.5 rounded bg-brand-primary-700 px-2.5 text-[11px] font-medium text-white transition-colors hover:bg-yellow-600">
        ...
        {!isLoading && (
          <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <div className="flex items-center justify-between rounded border border-neutral-200 p-2 dark:border-neutral-800">
              ...
              <AlertCircle className="h-4 w-4 text-brand-primary-700/70" />
            </div>
