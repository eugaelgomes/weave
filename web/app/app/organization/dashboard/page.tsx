        ...
        <div className="mx-auto max-w-7xl">
          {isLoading ? (
            ...
            <div className="rounded-lg border border-dashed border-neutral-300 bg-neutral-50 p-12 text-center dark:border-neutral-800 dark:bg-neutral-900/50">
              ...
              {!searchTerm && (
                <button className="inline-flex items-center justify-center gap-2 rounded-md bg-yellow-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-yellow-600">
                  <Plus className="h-4 w-4" />
