...
export default function ChatPage() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden rounded-md border border-neutral-200 bg-white text-neutral-900 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100">
      {/* ============================ DRAWER (DIV LATERAL) ============================ */}
      {/* Backdrop */}
      <div
      ...
      {/* ============================ HEADER ============================ */}
      <div className="flex h-14 flex-shrink-0 items-center justify-between border-b border-neutral-200 bg-white px-4 dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 rounded px-3 py-1.5 text-sm hover:bg-neutral-100 dark:hover:bg-neutral-800"
            >
          ...
          <select
            ...
            className="rounded border border-neutral-200 bg-white px-3 py-1.5 text-sm hover:bg-neutral-50 focus:outline-none dark:border-neutral-800 dark:bg-neutral-900 dark:hover:bg-neutral-800"
          >
            {useCases.map((uc) => (
          ...
          >
            {allowEdit ? <Unlock className="h-4 w-4" /> : <Lock className="h-4 w-4" />}
            Ações
          </button>
        </div>
      </div>
          ...
          <div className="space-y-6">
            {messages.map((msg) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className={`relative rounded-md px-4 py-2.5 text-sm leading-relaxed ${
                        isUser
                    ...
                    {!isUser && (
                      <div className="mt-1 flex items-center gap-2 px-1">
                        <button
                          ...
                          className="flex items-center gap-1 text-[10px] font-medium tracking-wider text-neutral-400 uppercase transition hover:text-neutral-600 dark:hover:text-neutral-300"
                        >
            ...
            {isTyping && (
              <div className="flex gap-4">
                ...
                <div className="flex items-center rounded-md rounded-tl-sm border border-neutral-200 bg-white px-5 py-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="mb-3 flex flex-wrap gap-2">
              {contextItems.map((item) => (
                <div
                  ...
                  className="flex items-center gap-2 rounded bg-blue-50 px-3 py-1.5 text-sm dark:bg-blue-900/20"
                >
                  {item.type === "note" ? (
                  ...
                  <span className="text-blue-700 dark:text-blue-300">{item.title}</span>
                  <button
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="flex h-11 w-11 items-center justify-center rounded border border-neutral-300 hover:bg-neutral-50 dark:border-neutral-700 dark:hover:bg-neutral-900"
              >
            ...
            <textarea
              ...
              className="max-h-32 min-h-[44px] flex-1 resize-none rounded border border-neutral-300 bg-white px-4 py-3 text-sm focus:border-neutral-400 focus:outline-none dark:border-neutral-700 dark:bg-neutral-900"
            />
            <button
              title="Enviar"
              onClick={handleSend}
              disabled={!input.trim()}
              className="flex h-11 w-11 items-center justify-center rounded bg-neutral-900 text-white hover:bg-black disabled:opacity-30 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200"
            >
