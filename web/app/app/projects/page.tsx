...
export default function ProjectsPage() {
  ...
  // 1. Definimos 'dashboard' como o estado inicial para abrir automaticamente
  ...
  return (
    <div className="flex min-h-[calc(100vh-5rem)] flex-col md:flex-row bg-white dark:bg-neutral-950 rounded-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden">
      ...
      {/* SIDEBAR LATERAL */}
      <div className="w-full md:w-[200px] flex-shrink-0 border-b md:border-b-0 md:border-r border-neutral-200 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900/30 overflow-y-auto">
        <div className="p-4">
          <h2 className="mb-3 text-[11px] font-bold tracking-wider text-neutral-500 dark:text-neutral-400 uppercase">
            Menu
          </h2>
          
          <ul className="space-y-1 mb-6">
            {/* 2. Opção Fixa do Dashboard como primeira escolha */}
            <li>
              <button
      ...
      <div className="flex flex-1 flex-col overflow-y-auto bg-white p-4 sm:p-6 dark:bg-neutral-950">
        
        {/* 3. Lógica de renderização condicional clara */}
        {selectedProjectId === "dashboard" ? (
          /* TELA INICIAL QUANDO DASHBOARD ESTÁ SELECIONADO */
