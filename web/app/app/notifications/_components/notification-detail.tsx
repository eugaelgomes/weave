    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex gap-4">
          <div
            className={cn(
              "mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-neutral-100 p-2 dark:bg-neutral-900",
              iconColor
            )}
          >
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              {actionRequired && (
                <div className="mt-4 border-t border-neutral-100 pt-4 dark:border-neutral-800">
                  ...
                  <div className="rounded-md border border-neutral-100 bg-neutral-50 p-3 dark:border-neutral-800 dark:bg-neutral-900/50">
