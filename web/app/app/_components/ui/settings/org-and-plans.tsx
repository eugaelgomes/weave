            ...
            <div className="mt-auto flex flex-wrap gap-2 pt-2">
              {user.org_member_role &&
                (Array.isArray(user.org_member_role)
                  ...
                  <span
                    key={idx}
                    className="inline-flex items-center rounded-md bg-yellow-500/10 px-2 py-1 text-xs font-medium text-yellow-700 ring-1 ring-yellow-500/20 ring-inset dark:bg-yellow-500/10 dark:text-yellow-500 dark:ring-yellow-500/20"
                  >
                    {formatRoleName(role)}
                  </span>
                ))}
        ...
        <div className="flex flex-col overflow-hidden rounded-xl border border-neutral-200/60 bg-white shadow-sm transition-all dark:border-neutral-800/60 dark:bg-neutral-950">
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-4 p-6 text-center">
            ...
            <Link
              ...
              className="mt-2 inline-flex items-center gap-2 rounded-lg bg-yellow-500 px-5 py-2 text-sm font-semibold text-neutral-950 shadow-sm transition-all hover:bg-yellow-400 focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:outline-none dark:focus:ring-offset-neutral-950"
            >
        ...
        (user.org_member_role === "admin" || user.org_member_role === "super_admin") && (
          <div className="flex flex-col overflow-hidden rounded-xl border border-neutral-200/60 bg-white shadow-sm transition-all dark:border-neutral-800/60 dark:bg-neutral-950">
            <div className="flex items-center justify-between border-b border-neutral-100/60 px-5 py-4 dark:border-neutral-800/50">
              ...
              <span className="inline-flex items-center rounded-md bg-emerald-50 px-2 py-0.5 text-[11px] font-medium text-emerald-600 ring-1 ring-emerald-500/20 ring-inset dark:bg-emerald-500/10 dark:text-emerald-400">
                Ativo
              </span>
            </div>
