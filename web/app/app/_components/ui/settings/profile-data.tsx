      ...
      <div className="p-4 sm:p-6">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="space-y-8 lg:col-span-9">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`${inputBaseClass} ${inputStateClass} ${editMode ? "pl-8" : "pl-0"}`}
                    />
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                ...
                <div className="flex items-end">
                  <label
                    className={`flex flex-1 items-center gap-3 rounded-md border px-3 py-1.5 transition-all ${editMode ? "cursor-pointer border-neutral-200 hover:border-amber-500" : "border-transparent px-0 opacity-100"}`}
                  >
                    <input
                      type="checkbox"
                      disabled={!editMode}
                      ...
                      className={`h-3.5 w-3.5 rounded border-neutral-300 text-amber-500 focus:ring-amber-500 ${!editMode && "accent-amber-500 opacity-100"}`}
                    />
            ...
            {editMode && (
              <div className="animate-in slide-in-from-top-2 space-y-4 border-t border-neutral-100 pt-6 duration-300 dark:border-neutral-800">
                <div className="rounded-md border border-amber-100/50 bg-amber-50/20 p-4 dark:border-amber-900/20 dark:bg-amber-900/5">
                  <h4 className="mb-3 flex items-center gap-2 text-[10px] font-bold tracking-widest text-amber-600">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <input
                      ...
                      className={`${inputBaseClass} border border-neutral-200 bg-white px-3 py-1.5 sm:col-span-2 dark:border-neutral-800 dark:bg-neutral-950`}
                      onChange={handleInputChange}
                    />
                    <input
                      type="password"
                      ...
                      className={`${inputBaseClass} border border-neutral-200 bg-white px-3 py-1.5 dark:border-neutral-800 dark:bg-neutral-950`}
                      onChange={handleInputChange}
                    />
                    <input
                      type="password"
