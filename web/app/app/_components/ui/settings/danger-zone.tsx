    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-[320px] bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-md shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between px-3 py-2 border-b border-neutral-100 dark:border-neutral-900">
          <span className="text-[10px] font-bold tracking-widest text-neutral-400">Verificação</span>
      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
          <div className="space-y-0.5">
            ...
            <p className="text-[11px] text-neutral-500 dark:text-neutral-400">Backup completo de dados (JSON/Zip).</p>
          </div>
        ...
        <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
          <div className="space-y-0.5">
            ...
            <p className="text-[11px] text-red-600/70 dark:text-red-400/60">Ação irreversível. Todos os dados serão deletados.</p>
          </div>
