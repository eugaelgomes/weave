        ...
        <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="max-w-xl space-y-1">
            ...
            <p className="text-xs text-neutral-500 dark:text-neutral-400">
              Descarregue uma cópia completa das suas notas, projetos e configurações em formato JSON/Zip.
            </p>
          ...
          <button
            ...
            className="flex w-full shrink-0 items-center justify-center gap-2 rounded-lg border border-neutral-200 bg-white px-4 py-2 text-xs font-medium text-neutral-700 shadow-sm transition-colors hover:bg-neutral-50 hover:text-neutral-900 focus:border-yellow-500 focus:outline-none focus:ring-1 focus:ring-yellow-500 disabled:opacity-50 sm:w-60 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-100"
          >
            {backupLoading ? (
        ...
        <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="max-w-xl space-y-1">
            ...
            <p className="text-xs text-red-600/80 dark:text-red-400/70">
              Esta ação é permanente. Todos os seus dados, projetos e notas serão removidos sem possibilidade de recuperação.
            </p>
          </div>
          <button
            onClick={handleDeleteAccount}
            className="flex w-full shrink-0 items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:w-60 dark:bg-red-500/10 dark:text-red-500 dark:hover:bg-red-600 dark:hover:text-white dark:focus:ring-offset-neutral-950"
          >
