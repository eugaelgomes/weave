          ...
          <button
            ...
            className={`rounded-md px-4 py-1.5 text-[11px] font-bold text-white transition-all ${
              variant === "danger"
                ...
                : "bg-brand-primary-700 hover:bg-yellow-600"
            }`}
          >
            {confirmText}
          </button>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-end gap-2 border-t border-neutral-100 bg-neutral-50 px-3 py-3 dark:border-neutral-800 dark:bg-neutral-900/50">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md bg-brand-primary-700 px-4 py-1.5 text-[11px] font-bold text-white transition-all hover:bg-yellow-600 disabled:opacity-50"
            >
    ...
    <div className="overflow-hidden rounded-md border border-neutral-200/60 bg-white shadow-sm dark:border-neutral-800/60 dark:bg-neutral-950">
      ...
      <div className="flex items-center justify-between border-b border-neutral-100/60 px-4 py-2 dark:border-neutral-800/60">
        <h3 className="flex items-center gap-2 text-[11px] font-bold tracking-[0.12em] text-neutral-500 dark:text-neutral-400">
          <KeyRound className="h-3.5 w-3.5 text-brand-primary-700" />
          API Tokens
        </h3>
      </div>
        ...
        <div className="mb-2 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="max-w-xl">
            <p className="text-[11px] leading-relaxed text-neutral-500 dark:text-neutral-400">
              ...
              <span className="ml-1 font-medium text-yellow-600 dark:text-brand-primary-700">
          ...
          <div className="flex flex-shrink-0 items-center justify-start sm:justify-end">
            {!isCreating && !generatedToken && (
              <button
                ...
                className="flex items-center gap-1.5 rounded-md bg-brand-primary-700 px-2 py-1 text-[11px] font-bold text-white shadow-sm transition-all hover:bg-yellow-600 active:scale-95"
              >
                <Plus size={14} />
                Novo Token
              </button>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="space-y-1">
                      ...
                      <p className="text-[11px] text-yellow-700/80 dark:text-brand-primary-700/80">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="flex h-8 items-center gap-2 rounded-md bg-brand-primary-700 px-3 text-[11px] font-bold text-white transition-colors hover:bg-yellow-600"
                      >
                          ...
                          return (
                            <label
                              ...
                              className={`group relative flex cursor-pointer items-start gap-3 rounded-md border p-3 transition-all duration-200 ${
                                isSelected
                                  ? "border-yellow-500/50 bg-yellow-50/30 ring-1 ring-yellow-500/10 dark:border-yellow-500/40 dark:bg-brand-primary-700/5"
                            ...
                            >
                              <div className="relative mt-0.5 flex items-center">
                                ...
                                />
                                <div className="h-4 w-7 rounded-full bg-neutral-300 transition-colors peer-checked:bg-brand-primary-700 peer-focus-visible:ring-2 peer-focus-visible:ring-yellow-500 peer-focus-visible:ring-offset-1 dark:bg-neutral-700 dark:peer-focus-visible:ring-offset-neutral-950"></div>
                ...
                <div className="flex items-center justify-between border-t border-neutral-200/40 pt-4 dark:border-neutral-800/40">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-md bg-brand-primary-700 px-4 py-1.5 text-[11px] font-bold text-white transition-all hover:bg-yellow-600 disabled:cursor-not-allowed disabled:opacity-50"
                    >
              ...
              <div className="flex items-center justify-between rounded-md border border-neutral-100 bg-neutral-50 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900/30">
                <div className="flex items-center gap-4 text-[11px] font-bold">
                  <span className="flex items-center gap-1.5 text-neutral-700 dark:text-neutral-300">
                    <span className="h-2 w-2 rounded-full bg-brand-primary-700"></span>
                    ...
                    <div
                      ...
                      className={`group flex items-center justify-between rounded-md border p-3 transition-all ${
                        token.revoked_at
                          ...
                          : "border-yellow-500/10 bg-yellow-50/5 hover:border-yellow-500/30 dark:border-yellow-500/5 dark:bg-brand-primary-700/5 dark:hover:border-yellow-500/20"
                      }`}
                    >
                        ...
                        <div
                          className={`rounded-md p-2 ${
                            token.revoked_at
                              ...
                              : "bg-yellow-100/50 dark:bg-brand-primary-700/20"
                          }`}
                        >
                          <KeyRound
                            size={14}
