    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-neutral-200 bg-neutral-100 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="flex items-center gap-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-brand-primary-500/10 text-yellow-600">
      ...
      <div className="border-t border-neutral-200 bg-neutral-50 p-3 dark:border-neutral-800 dark:bg-neutral-950">
        <div className="flex items-end gap-2">
          ...
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-brand-primary-500 text-white transition-all hover:bg-yellow-600 disabled:opacity-50"
          >
