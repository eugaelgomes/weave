      ...
      {notes.length === 0 ? (
        <div className="py-4 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded bg-brand-primary-700 px-3 py-1.5 text-[10px] font-semibold text-white shadow-sm transition-colors hover:bg-yellow-600"
          >
                    ...
                    <div>
                      <div className="mb-1.5 flex items-start justify-between gap-1.5">
                        <div className="flex items-center gap-1.5">
                          ...
                          <h2 className="line-clamp-2 text-xs leading-tight font-semibold text-neutral-900 transition-colors group-hover:text-yellow-600 dark:text-neutral-100 dark:group-hover:text-brand-primary-700">
                        ...
                        {isNew && (
                          <span
                            className="flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-brand-primary-700 shadow-sm"
                            title="Nova"
                          />
                        )}
                      </div>
