...
export default function NotFound() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-brand-primary-700/5 blur-3xl" />
      <div className="pointer-events-none absolute -right-32 -bottom-32 h-96 w-96 rounded-full bg-brand-primary-700/5 blur-3xl" />

      <div className="w-full max-w-md text-center">
        <div className="mb-8">
          <div className="mb-2 text-[8rem] leading-none font-black tracking-tighter text-brand-primary-700/20">
            404
          </div>
        ...
        <div className="mt-8 space-y-2 border-t border-neutral-800/50 pt-6">
          <div className="">
            <p className="text-sm text-neutral-500">
              Precisa de ajuda?{" "}
              <Link href="/support/" className="tex-underline font-semibold text-brand-primary-700">
                Clique aqui
              </Link>{" "}
