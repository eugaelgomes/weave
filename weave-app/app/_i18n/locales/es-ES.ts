...
const esES: TranslationKeys = {
  ...
  reasoningComposer: {
    hub: {
      title: "Compositor del Weave Engine",
      subtitle: "Elige qué crear. La guía te acompaña en cada paso.",
      back: "Volver",
      insightTitle: "Publicar insight",
      insightDescription: "Escribe un insight manual con editor enriquecido, plantillas y revisión.",
      instructionsTitle: "Instrucciones del engine",
      instructionsDescription: "Define cómo la IA debe analizar este proyecto en informes proactivos.",
    },
    insight: {
      title: "Publicar insight",
      subtitle: "Sigue los pasos. Inserta una plantilla y revisa antes de publicar.",
      back: "Volver",
      stepLabel: "Paso",
      next: "Continuar",
      previous: "Volver",
      ...
      stepProjectHint: "Selecciona el proyecto donde se publicará este insight.",
      stepTypeHint: "Elige el tipo de insight para organizar el feed.",
      stepTitleHint: "Añade un título claro. Usa una sugerencia si prefieres.",
      stepContentHint: "Escribe el contenido con formato, listas y tareas como en las notas.",
      stepReviewHint: "Revisa todo antes de publicar.",
      ...
      sidebarGuide: "Guía",
      sidebarHint: "Completa los elementos. Publicar se habilita cuando todo esté listo.",
      checklist: {
        project: "Proyecto con sprint activa",
    ...
    instructions: {
      ...
      subtitle: "Personaliza cómo la IA genera insights proactivos para este proyecto.",
      back: "Volver",
      stepLabel: "Paso",
      next: "Continuar",
      previous: "Volver",
      ...
      stepProjectHint: "Selecciona el proyecto cuyas instrucciones quieres editar.",
      stepScopeHint: "Global aplica a todos los tipos; por tipo solo ese informe.",
      stepContentHint: "Describe tono, foco y reglas. Las reglas de seguridad por defecto se mantienen.",
      stepReviewHint: "Revisa el resumen antes de guardar.",
      pickProject: "Selecciona un proyecto",
      ...
      sidebarGuide: "Guía",
      sidebarHint: "El texto se añade a las instrucciones por defecto, no las reemplaza por completo.",
      checklist: {
        project: "Proyecto con informes IA",
        scope: "Ámbito definido",
        content: "Instrucciones completadas",
      },
      typeDescriptions: {
