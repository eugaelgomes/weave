const ptBR = {
  ...
  reasoningComposer: {
    hub: {
      title: "Composer do Weave Engine",
      subtitle: "Escolha o que deseja criar. O assistente guia cada passo.",
      back: "Voltar",
      insightTitle: "Publicar insight",
      insightDescription: "Escreva um insight manual com editor rico, modelos e revisão antes de publicar.",
      instructionsTitle: "Instruções do engine",
      instructionsDescription: "Defina como a IA deve analisar este projeto nos relatórios proativos.",
    },
    insight: {
      title: "Publicar insight",
      subtitle: "Siga os passos. Você pode inserir um modelo e revisar antes de publicar.",
      back: "Voltar",
      stepLabel: "Passo",
      next: "Continuar",
      previous: "Voltar",
      ...
      stepProjectHint: "Selecione o projeto onde este insight será publicado.",
      stepTypeHint: "Escolha o tipo de insight. Isso ajuda a organizar o feed.",
      stepTitleHint: "Dê um título claro. Use uma sugestão se preferir.",
      stepContentHint: "Escreva o conteúdo. Use formatação, listas e tarefas como nas notas.",
      stepReviewHint: "Revise tudo antes de publicar.",
      ...
      sidebarGuide: "Guia",
      sidebarHint: "Complete os itens abaixo. O botão publicar libera quando tudo estiver pronto.",
      checklist: {
        project: "Projeto com sprint ativa",
    ...
    instructions: {
      ...
      subtitle: "Personalize como a IA gera insights proativos para este projeto.",
      back: "Voltar",
      stepLabel: "Passo",
      next: "Continuar",
      previous: "Voltar",
      ...
      stepProjectHint: "Selecione o projeto cujas instruções você quer editar.",
      stepScopeHint: "Instruções globais valem para todos os tipos; por tipo substituem apenas aquele relatório.",
      stepContentHint: "Descreva tom, foco e regras. O engine sempre mantém regras de segurança padrão.",
      stepReviewHint: "Confira o resumo antes de salvar.",
      pickProject: "Selecione um projeto",
      ...
      sidebarGuide: "Guia",
      sidebarHint: "Textos aqui são adicionados às instruções padrão do Weave Engine, sem substituí-las por completo.",
      checklist: {
        project: "Projeto com relatórios IA",
        scope: "Escopo definido",
        content: "Instruções preenchidas",
      },
      typeDescriptions: {
