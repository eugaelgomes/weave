  ...
  const sidebarContent = (
    <div className="p-2.5">
      ...
      <button
        ...
        className="dark:border-surface-dark-border mb-4 flex w-full items-center justify-center gap-1.5 rounded-md border border-neutral-200 bg-neutral-900 px-2 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:bg-neutral-800 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-200"
      >
    ...
    <div className="flex min-h-0 w-full flex-1 flex-col gap-2 md:px-0">
      ...
      {isMobileSidebarOpen && (
        <div className="fixed inset-0 z-40 flex md:hidden">
          ...
          <div className="dark:border-surface-dark-border ml-auto flex h-full w-[80%] max-w-xs flex-col border-l border-neutral-200 bg-white shadow-xl dark:bg-[#1d1d1b]">
