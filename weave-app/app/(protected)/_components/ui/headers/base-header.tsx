...
export function BaseHeader({ className, leftContent, rightContent }: BaseHeaderProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-row items-center justify-between gap-3 rounded-md border border-gray-200 border-l-4 border-l-brand-primary-500 bg-white p-2 shadow-sm backdrop-blur-sm sm:gap-4 sm:px-3 sm:py-1.5 dark:border-neutral-600 dark:bg-[#1d1d1b]/50 dark:shadow-surface-dark-sm",
        className
      )}
    >
      {/* Lado Esquerdo */}
