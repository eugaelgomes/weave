          ...
          {visiblePages.map((page) => (
            <button
              ...
              className={`flex h-6 w-6 items-center justify-center rounded-md text-[10px] font-medium transition-all ${
                page === currentPage
                  ? "dark:bg-brand-primary-500/10 dark:text-brand-primary-500 border border-yellow-200 bg-yellow-50 text-yellow-600 shadow-sm dark:shadow-surface-dark-sm dark:border-surface-dark-border"
