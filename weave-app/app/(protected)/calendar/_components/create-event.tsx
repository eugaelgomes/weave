...
export default function CreateEventModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
      ...
      <div className="animate-in zoom-in-95 fade-in relative w-full max-w-lg rounded-md bg-white shadow-xl ring-1 ring-neutral-200 duration-200 dark:bg-[#1d1d1b] dark:ring-neutral-800">
        {/* Botão de Fechar */}
