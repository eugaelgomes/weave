...
export function ComposeOptionChips({
  chips,
  labels,
  onSelect,
  disabled,
}: ComposeOptionChipsProps) {
      ...
      {chips.map((chip) => (
        <button
          ...
          className={cn(
            ...
            "hover:border-neutral-300 hover:bg-white dark:border-surface-dark-border dark:bg-neutral-900/40 dark:text-neutral-200 dark:hover:bg-neutral-800",
