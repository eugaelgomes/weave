...
export default function WeaveEngineLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-0 w-full flex-1 flex-col gap-2 md:px-0">
      ...
      <main className="dark:shadow-surface-dark-sm flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto bg-white md:rounded-md md:border md:border-neutral-200 md:shadow-sm dark:bg-[#1d1d1b] md:dark:border-surface-dark-border">
