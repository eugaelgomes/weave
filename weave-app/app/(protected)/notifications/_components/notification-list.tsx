...
const getNotificationIcon = (type: NotificationType) => {
  switch (type) {
    ...
    case "ai_action":
      return <Bot className="text-brand-primary-500 h-4 w-4" />;
    case "job_action":
...
export function NotificationList({ notifications }: NotificationListProps) {
  if (notifications.length === 0) {
    return (
      <div className="dark:shadow-surface-dark-sm dark:border-surface-dark-border flex h-64 flex-col items-center justify-center gap-2 rounded-md border border-neutral-200 bg-white p-8 text-neutral-500 shadow-sm dark:bg-[#1d1d1b]">
          ...
          <Link
            ...
            className={cn(
              ...
              notification.is_read
                ? "dark:border-surface-dark-border border-neutral-200 bg-white text-neutral-600 dark:bg-[#1d1d1b] dark:text-neutral-400"
