        ...
        {userIsOwner && (
          <form onSubmit={handleAddDomain} className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm outline-none focus:border-zinc-400 focus:ring-2 focus:ring-zinc-100 dark:border-surface-dark-border dark:bg-[#1d1d1b] dark:text-zinc-100"
              disabled={isAdding}
            />
            <button
              type="submit"
        ...
        <div className="space-y-4">
          {domains.length === 0 && !loading ? (
            ...
            domains.map((domain) => (
              <div
                key={domain.id}
                className="rounded-md border border-zinc-100 bg-zinc-50/50 p-4 dark:border-surface-dark-border-strong dark:bg-[#1d1d1b]/30"
              >
