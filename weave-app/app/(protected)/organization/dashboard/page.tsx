...
const ProjectsPage = () => {
  ...
  return (
    <div className="animate-in fade-in flex h-full flex-col duration-300">
      ...
      {/* Page Header */}
      <div className="dark:border-surface-dark-border border-b border-neutral-200 bg-neutral-50 p-6 dark:bg-[#1d1d1b]">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="dark:border-surface-dark-border-strong h-10 w-full rounded-md border border-neutral-300 bg-white pr-4 pl-9 text-sm focus:border-yellow-500 focus:ring-1 focus:ring-yellow-500 focus:outline-none sm:w-64 dark:bg-[#1d1d1b] dark:text-neutral-100"
              />
            </div>
      ...
      <div className="flex-1 overflow-y-auto bg-white p-6 dark:bg-[#1d1d1b]">
        <div className="mx-auto max-w-7xl">
          {isLoading ? (
            ...
            /* Empty State */
            <div className="dark:border-surface-dark-border rounded-lg border border-dashed border-neutral-300 bg-neutral-50 p-12 text-center dark:bg-[#1d1d1b]/50">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {filteredProjects.map((project) => (
                <Link
                  ...
                  key={project.id}
                  className="group dark:shadow-surface-dark-md dark:border-surface-dark-border flex flex-col justify-between rounded-xl border border-neutral-200 bg-white p-5 transition-all hover:border-yellow-500 hover:shadow-md dark:bg-[#1d1d1b] dark:hover:border-yellow-500"
                >
                  <div>
                  ...
                  <div className="dark:border-surface-dark-border mt-auto flex items-center justify-between border-t border-neutral-100 pt-4">
                    <div className="flex -space-x-2">
                      {/* Avatar placeholder - idealmente viria dos membros do projeto */}
                      <div className="dark:border-surface-dark-border-strong h-7 w-7 rounded-full border-2 border-white bg-neutral-200 dark:bg-neutral-700" />
                      <div className="dark:border-surface-dark-border-strong h-7 w-7 rounded-full border-2 border-white bg-neutral-300 dark:bg-neutral-600" />
                      <div className="dark:border-surface-dark-border-strong flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-neutral-100 text-[10px] font-medium text-neutral-600 dark:bg-neutral-800 dark:text-neutral-300">
                        +3
                      </div>
                    </div>
