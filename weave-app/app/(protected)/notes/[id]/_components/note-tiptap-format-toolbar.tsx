...
import { CODE_BLOCK_LANGUAGE_OPTIONS } from "./note-tiptap-code-languages";
import { getNoteEditorImageUploader } from "./note-tiptap-editor-bridge";
...
export interface NoteTiptapFormatToolbarProps {
  editor: Editor;
...
export function NoteTiptapFormatToolbar({
  editor,
  variant,
  slashRange,
  density = "default",
  onAfterAction,
}: NoteTiptapFormatToolbarProps) {
  ...
  const uploadDocumentImages = getNoteEditorImageUploader(editor);
