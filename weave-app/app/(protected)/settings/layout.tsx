    ...
    <div className="flex min-h-0 w-full flex-1 flex-col gap-2 md:px-0">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        <div className="flex min-h-0 flex-1 flex-col md:flex-row md:gap-2">
          ...
          <div className="hidden w-full flex-shrink-0 overflow-y-auto rounded-md border border-neutral-200 bg-white shadow-md md:sticky md:block md:h-[calc(100vh-auto)] md:w-[180px] dark:border-surface-dark-border dark:bg-[#1d1d1b]/50">
            {sidebarContent}
          </div>
