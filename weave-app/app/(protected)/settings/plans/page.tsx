    ...
    <>
          ...
          {user?.plan_id ? (
            <div className={cardBase}>
              ...
              <div className="flex flex-1 flex-col gap-6 p-4 md:flex-row">
                <div className="flex w-full flex-col items-start justify-between gap-4 border-b border-neutral-100/60 pb-4 md:w-1/3 md:border-r md:border-b-0 md:pr-4 md:pb-0 dark:border-surface-dark-border">
                  <div className="space-y-3">
                    ...
                    {historyMetadata?.usage_percentage_total && (
                      <div className="flex items-center gap-2 rounded-md border border-neutral-100 bg-neutral-50 p-2 dark:border-surface-dark-border-strong/50 dark:bg-neutral-800/50">
      ...
      {showUsageModal && (
        <div className="animate-in fade-in fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm transition-all duration-300">
          <div className="animate-in zoom-in-95 w-full max-w-3xl overflow-hidden rounded-lg border border-neutral-200 bg-white shadow-2xl dark:shadow-surface-dark-xl dark:border-surface-dark-border dark:bg-[#1d1d1b]">
            <div className="flex items-center justify-between border-b border-neutral-100 bg-neutral-50/50 px-6 py-4 dark:border-surface-dark-border dark:bg-[#1d1d1b]/20">
            ...
            <div className="p-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="flex flex-col rounded-md border border-neutral-100 bg-neutral-50/50 p-4 transition-colors dark:border-surface-dark-border-muted dark:bg-[#1d1d1b]/30">
            ...
            <div className="flex justify-end border-t border-neutral-100 bg-neutral-50/50 px-6 py-4 dark:border-surface-dark-border dark:bg-[#1d1d1b]/20">
              <button
                onClick={() => setShowUsageModal(false)}
