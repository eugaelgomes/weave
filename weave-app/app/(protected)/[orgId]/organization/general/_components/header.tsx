...
import { Input } from "@/app/(protected)/[orgId]/organization/general/_components/form-primitives";
import type { WorkspaceOverviewProps } from "@/app/(protected)/[orgId]/organization/general/_components/settings-types";
  ...
  return (
    <div className="space-y-6">
      <OrganizationHeroCard
        ...
        onEditLogo={() => setEditingImage("logo")}
        onEditBanner={() => setEditingImage("banner")}
        onOpenEditModal={() => setIsEditingInfo(true)}
      />
