  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSearch} className="flex gap-2">
        ...
        <button
          type="submit"
          className="rounded-lg bg-brand-primary-500 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-yellow-400"
        >
          Buscar
        </button>
      </form>
            ...
            {loading ? (
              <tr>
                <td colSpan={4} className="px-4 py-8 text-center">
                  <FaSpinner className="mx-auto h-6 w-6 animate-spin text-brand-primary-500" />
                </td>
              </tr>
            ) : users.length === 0 ? (
              <tr>
