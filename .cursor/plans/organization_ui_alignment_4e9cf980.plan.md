...
overview: "Alinhar todas as rotas em `app/(protected)/organization` ao padrão visual do resto do weave-app: paleta neutral + superfície `#1d1d1b`, bordas/sombras `surface-dark-*`, headers partilhados e tipografia coerente, substituindo o bloco zinc-centric e inconsistências de layout."
todos:
  - id: org-settings-components
    ...
    status: pending
  - id: org-create
    content: Refatorar organization/create/page.tsx para o mesmo padrão de cartão/CTA/tipografia
    status: pending
  - id: org-areas
    content: Auditar organization/areas/page.tsx por secções; unificar classes de cartão/borda/sombra e reduzir duplicação se útil
    status: pending
  - id: org-about-members
    content: Melhorar about/[id]/page.tsx; rever members list/invites por resíduos fora do padrão
    status: pending
  - id: org-qa
    content: QA dark/light nas rotas /organization/**
    status: pending
isProject: false
---
...
- **Cartões / painéis:** `border border-neutral-200 bg-white shadow-sm dark:border-surface-dark-border dark:bg-[#1d1d1b] dark:shadow-surface-dark-sm` (ou `md` em blocos grandes), como em [organization/projects/page.tsx](weave-app/app/(protected)/organization/projects/page.tsx) e [organization/dashboard/page.tsx](weave-app/app/(protected)/organization/dashboard/page.tsx).
...
|------|-----------|----------|
| Alta | [create/page.tsx](weave-app/app/(protected)/organization/create/page.tsx) | Dominância de `border-zinc-*`, `text-zinc-*`, `bg-zinc-*`, steps laterais com outro idioma visual |
| Alta | [settings/_components/header.tsx](weave-app/app/(protected)/organization/settings/_components/header.tsx), [settings-form.tsx](weave-app/app/(protected)/organization/settings/_components/settings-form.tsx), [domains-section.tsx](weave-app/app/(protected)/organization/settings/_components/domains-section.tsx), [ui-elements.tsx](weave-app/app/(protected)/organization/settings/_components/ui-elements.tsx) | Paleta zinc + gradientes `from-zinc-*`; modais e formulários fora do padrão neutral/surface |
| Média | [settings/page.tsx](weave-app/app/(protected)/organization/settings/page.tsx) | Estados loading / deleted com `zinc-*` e CTAs `bg-zinc-900` |
| Média | [areas/page.tsx](weave-app/app/(protected)/organization/areas/page.tsx) | Ficheiro grande (~1.3k linhas): mistura `clsx` + muitos `rounded-md border border-neutral-*`; auditar e substituir o que ainda for cinza “solto” sem `surface-dark-*` / sombra dark onde há cartão |
| Baixa | [about/[id]/page.tsx](weave-app/app/(protected)/organization/about/[id]/page.tsx) | Stub quase sem layout: falta card, tipografia neutral e conteúdo mínimo alinhado |
| Verificação | [members/list/page.tsx](weave-app/app/(protected)/organization/members/list/page.tsx), [members/invites/page.tsx](weave-app/app/(protected)/organization/members/invites/page.tsx) | Já usam tokens em modais; rever toolbars/tabelas por `grep` `zinc-\|`neutral-800` sem `surface` |
...
2. **Componentes partilhados de org settings primeiro**  
   Normalizar [ui-elements.tsx](weave-app/app/(protected)/organization/settings/_components/ui-elements.tsx) (inputs, switch, labels) para que [settings-form.tsx](weave-app/app/(protected)/organization/settings/_components/settings-form.tsx) e [domains-section.tsx](weave-app/app/(protected)/organization/settings/_components/domains-section.tsx) herdem o mesmo aspeto que `/settings/*` sem duplicar estilos.
...
6. **QA**  
   - Percorrer em dark: `/organization/settings`, `/organization/create`, `/organization/areas`, `/organization/projects`, `/organization/dashboard`, `/organization/members/*`, `/organization/about/*`.  
...
- Zero (ou residual justificado) de `zinc-` em `app/(protected)/organization/**/*.tsx` para **layout**.  
