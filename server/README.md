...
| Method | Path                                 | Notes                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------ | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | `/projects`                          | Filters: `search`, `status`, `methodology` (CSV: `KANBAN`, `SCRUM` only), `visibility`, `ownership`, `owner_user_id`, `collaborator_user_id`, `workspace_id` (org-wide roles only), `parent_only`, `has_parent`, date ranges (`created_*`, `updated_*`, `start_*`, `target_end_*`), `progress_min`/`max`, `priority`, `tags`, `active`. `include=collaborators,notes,subprojects`. `sort=field:asc\|desc`. |
