/**
 * @module agent-house/repositories/chat.repository
 ...
 *
 * Used by:
 * - `agent-house/services/chat-orchestrator.service.js`: To persist user and assistant messages, and fetch history.
 * - `agent-house/controllers/chat.controller.js`: For fetching history and managing session lifecycles.
 */
...
class WeaveAIRepository {
  ...
  /**
   * Generates and saves a unique share token for a chat session.
   *
   * @param {string} sessionId - UUID of the session.
   * @param {string} userId - UUID of the user owning the session.
   * @returns {Promise<string|null>} The generated share token.
   */
  ...
  /**
   * Retrieves a session preview by its share token (without exposing user_id).
   *
   * @param {string} token - The share token.
   * @returns {Promise<object|null>} The session preview.
   */
  ...
  /**
   * Forks a shared session into a new session for a different user.
   * Copies all messages up to the point of sharing.
   *
   * @param {string} token - The share token of the original session.
   * @param {string} newUserId - UUID of the user receiving the fork.
