/**
 * @module agent-house/utils/normalize
 ...
 *
 * Used by:
 * - `agent-house/controllers/agents.controller.js`: To sanitize input and format DB agent models to API shapes.
 * - `agent-house/repositories/agents.repository.js`: (Indirectly) ensures data consistency.
 */
/**
