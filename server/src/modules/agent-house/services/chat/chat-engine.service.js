/**
 * @module agent-house/services/chat-engine.service
 ...
 *
 * Used by:
 * - `agent-house/services/chat-orchestrator.service.js`: To dispatch generation requests during the chat loop.
 */
...
class ChatEngineService {
  ...
  async buildPlanUsageContext(userId, workspaceId = null) {
    try {
      ...
      console.error("[agent-house/chat] failed to fetch plan usage context", {
