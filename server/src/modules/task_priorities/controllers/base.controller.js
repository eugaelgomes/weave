/**
 * Controller base de prioridades de tarefa: validação de usuário autenticado (`verifyToken`).
 */
class TaskPrioritiesBaseController {
  /**
...
module.exports = TaskPrioritiesBaseController;
