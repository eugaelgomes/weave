...
const { apiTokenParamsSchema, createApiTokenSchema } = require("./schemas/api-tokens.schema");
...
router.get("/get-tokens", ListApiTokensController.listTokens.bind(ListApiTokensController));
router.post(
  "/create-token",
