...
/**
 * Exportação de notas/blocos/colaboradores para backup.
 */
class FetchBackupDataRepository extends BaseRepository {
  /**
   * @param {string} userId
...
module.exports = new FetchBackupDataRepository();
