...
const ORG_PERMISSIONS = Object.freeze({
  /** View/edit/manage any project with org_id = active workspace (admin / super_admin) */
  ACCESS_ALL_ORG_PROJECTS: "access_all_org_projects",

  /** Team structure; super_admin (DB role), aligned with team managers in controller */
  MANAGE_AREAS: "manage_areas",

  /** Change workspace plan / billing (when self-service endpoint exists) */
  ...
  /** View workspace members directory */
