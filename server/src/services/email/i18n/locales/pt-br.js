...
module.exports = {
  ...
  "loginCode.cta": "Entrar com código",
  "loginCode.info": "Este código expira em 10 minutos.",
  "loginCode.intro1": "Recebemos uma tentativa de acesso para sua conta.",
  "loginCode.intro2": "Use o código abaixo para entrar no Weave.",
  "loginCode.outro": "Se você não solicitou este acesso, ignore este e-mail.",
  "loginCode.preheader": "Seu código de login do Weave.",
  "loginCode.subject": "Seu código de login — Weave",
  "loginCode.subtitle": "Acesso à conta",
  "loginCode.title": "Seu código de login",
  ...
  "verificationCode.info": "Este código expira em 7 dias.",
  "verificationCode.intro": "Use o código abaixo para confirmar seu e-mail.",
  "verificationCode.outro": "Se você não solicitou esta confirmação, ignore este e-mail.",
  "verificationCode.preheader": "Seu código de confirmação do Weave.",
  "verificationCode.subject": "Seu código de confirmação — Weave",
  "verificationCode.subtitle": "Confirmação de e-mail",
  "verificationCode.title": "Seu código de confirmação",
