...
<head>
  ...
  <title>Validação de Mudança de Email - Weave Notes</title>
  <style>
    html, body {
...
<body>
  <center style="width: 100%; background-color: #fafafa;">
    <div class="container">
      <div class="header">
        <h1>Weave Notes</h1>
        <small>Validação de mudança de email</small>
      </div>
      
      <div class="main-content">
        <h2>Confirme a mudança do seu email</h2>
        
        <p>Prezado(a),</p>
        
        <p>Recebemos uma solicitação para alterar o email da sua conta. Para confirmar esta mudança, clique no botão abaixo:</p>

        <div class="email-info">
          <p style="margin: 5px 0;"><strong>Email atual:</strong> ${currentEmail}</p>
          <p style="margin: 5px 0;"><strong>Novo email:</strong> ${newEmail}</p>
        </div>

        <div style="text-align: center;">
          <a href="${validationLink}" class="button">Confirmar Mudança de Email</a>
        </div>
        ...
        <p>Caso o botão não funcione, utilize o token abaixo:</p>
