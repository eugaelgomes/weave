...
const blocksFunctions = {
  get_note_blocks: {
    name: "get_note_blocks",
    description:
      "Busca todos os blocos de uma nota em ordem hierárquica e de posição.",
    category: FunctionCategory.BLOCKS,
    security: SecurityLevel.SAFE,
    parameters: {
      type: "object",
      properties: {
    ...
    returns: {
      type: "array",
      description: "Array de blocos estruturados",
    },
  },
  ...
  create_block: {
    name: "create_block",
    description:
      "Cria um novo bloco em uma nota. Blocos podem ter hierarquia (parentId).",
    category: FunctionCategory.BLOCKS,
    security: SecurityLevel.MODERATE,
    requiresConfirmation: true,
    parameters: {
      ...
      properties: {
        ...
        parentId: {
          type: "string",
          description: "ID do bloco pai para hierarquia (UUID, opcional)",
        },
        properties: {
          type: "object",
          description:
            "Propriedades adicionais (ex: language para code, level para heading)",
        },
        position: {
          type: "integer",
          description: "Posição do bloco (opcional, será calculada se omitido)",
        },
      },
      required: ["noteId", "type", "text"],
    },
    returns: {
      type: "object",
      description: "Bloco criado com ID",
    },
  },

  update_block: {
    name: "update_block",
    description: "Atualiza o conteúdo ou propriedades de um bloco existente.",
    category: FunctionCategory.BLOCKS,
    security: SecurityLevel.MODERATE,
    requiresConfirmation: true,
    parameters: {
      ...
      properties: {
        blockId: {
          type: "string",
          description: "ID do bloco (UUID)",
        },
        text: {
          type: "string",
          description: "Novo texto (opcional)",
        },
        properties: {
          type: "object",
          description: "Novas propriedades (opcional)",
        },
        done: {
          type: "boolean",
          description: "Marcar checkbox como done/undone (opcional)",
        },
      },
      required: ["blockId"],
    },
  ...
  delete_block: {
    name: "delete_block",
    description:
      "Marca um bloco como deletado (soft delete). Blocos filhos também são marcados.",
    category: FunctionCategory.BLOCKS,
    security: SecurityLevel.RESTRICTED,
    requiresConfirmation: true,
    parameters: {
      ...
      properties: {
        blockId: {
          type: "string",
          description: "ID do bloco a deletar (UUID)",
        },
      },
      required: ["blockId"],
    },
