/**
 * @module agent-house/schemas/function-schemas
 ...
 *
 * Used by:
 * - `agent-house/policies/authorized-functions.js`: To resolve which of these schemas the current user/context can access.
 */
