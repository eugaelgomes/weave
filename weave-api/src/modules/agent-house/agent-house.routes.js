...
// Agent House - LLMs
router.post("/agents/llms", requireManageWeaveAi, validate(createLlmSchema, "body"), createLlmConfig);
router.get("/agents/llms", getLlmConfigs);
router.put("/agents/llms/:id", requireManageWeaveAi, validate(updateLlmSchema, "body"), updateLlmConfig);
router.delete("/agents/llms/:id", requireManageWeaveAi, deleteLlmConfig);

// Agent House - Custom Tools
router.post("/agents/tools", requireManageWeaveAi, validate(createCustomToolSchema, "body"), createCustomTool);
router.get("/agents/tools", getCustomTools);
router.put("/agents/tools/:id", requireManageWeaveAi, validate(updateCustomToolSchema, "body"), updateCustomTool);
