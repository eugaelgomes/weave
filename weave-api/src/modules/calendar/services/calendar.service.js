...
class CalendarEventsService {
  ...
  async createEvent(body, creatorId) {
    ...
    const createdEvent = await calendarRepository.createEvent(payload);
  ...
  async updateEvent(eventId, body, creatorId) {
    ...
    const current = await calendarRepository.getEventById({
      creatorId,
      eventId,
    });
  ...
  async deleteEvent(eventId, creatorId) {
    const result = await calendarRepository.softDeleteEvent({
      creatorId,
      eventId,
    });
